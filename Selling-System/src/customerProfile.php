...
<body>
        ...
        <div class="container">
            ...
            <div class="top-nav">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="mb-0" id="pageHeader">پڕۆفایلی قەرزار</h4>
                    <div class="d-flex">
                        <a href="customerDebts.php" class="btn btn-outline-secondary">
            ...
            <div class="card mb-4 customer-profile-header">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
            ...
            <div class="tab-content mt-3" id="customerProfileTabsContent">
                ...
                <div class="tab-pane fade show active" id="purchases" role="tabpanel" aria-labelledby="purchases-tab">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover dt-responsive nowrap w-100" id="purchasesTable">
                            <thead>
                                <tr>
                                    <th>ژمارەی وەسڵ</th>
                                    <th>بەروار</th>
                ...
                <div class="tab-pane fade" id="payments" role="tabpanel" aria-labelledby="payments-tab">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover dt-responsive nowrap w-100" id="paymentsTable">
                            <thead>
                                <tr>
                                    <th>ژمارە</th>
                                    <th>بەروار</th>
    ...
    <script>
        // Set DataTables defaults for RTL support
