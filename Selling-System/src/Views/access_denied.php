...
<body>
    <div class="access-denied-container">
        ...
        <h1>دەسەڵاتت نییە</h1>
        <p>
            ببورە، تۆ دەسەڵاتت نییە بۆ بینینی ئەم پەڕەیە یان ئەنجامدانی ئەم کردارە.
            ڕۆڵی بەکارهێنەرەکەت دەسەڵاتی پێویستی بۆ ئەم کردارە نییە.
            تکایە پەیوەندی بکە بە بەڕێوەبەری سیستەم بۆ وەرگرتنی ڕێگەپێدانی پێویست.
        </p>
