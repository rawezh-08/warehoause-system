...
<body>
                        ...
                        <div class="card summary-card bg-white border-0">
                            <div class="card-body d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <?php
                                    // Calculate total returns for this supplier
                                    $totalReturnsQuery = "SELECT COALESCE(SUM(pr.total_amount), 0) as total_returns 
                                                       FROM product_returns pr 
                                                       JOIN purchases p ON pr.receipt_id = p.id 
                                                       WHERE pr.receipt_type = 'buying' 
                                                       AND p.supplier_id = :supplier_id";
                                    $totalReturnsStmt = $conn->prepare($totalReturnsQuery);
                                    $totalReturnsStmt->bindParam(':supplier_id', $supplierId);
                                    $totalReturnsStmt->execute();
                                    $totalReturns = $totalReturnsStmt->fetch(PDO::FETCH_ASSOC)['total_returns'];
                                    
                                    echo number_format($totalReturns); 
                                    ?> دینار</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-header bg-transparent p-0 border-bottom-0">
                        <ul class="nav nav-tabs custom-tabs border-0" id="supplierTabs" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="returns-history-tab" data-bs-toggle="tab" data-bs-target="#returns-history-content" type="button" role="tab" aria-controls="returns-history-content" aria-selected="false">
                                    <i class="fas fa-undo"></i>مێژووی گەڕاندنەوەی کاڵا
                                </button>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <!-- Returns History Tab -->
                            <div class="tab-pane fade" id="returns-history-content" role="tabpanel" aria-labelledby="returns-history-tab">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h5 class="card-title mb-0">مێژووی گەڕاندنەوەی کاڵا</h5>
                                ...
                                <div class="table-responsive">
                                    <table id="returnsHistoryTable" class="table table-bordered custom-table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $returnsQuery = "SELECT pr.*, p.invoice_number
                                                         FROM product_returns pr 
                                                         JOIN purchases p ON pr.receipt_id = p.id 
                                                         WHERE pr.receipt_type = 'buying' 
                                                         AND p.supplier_id = :supplier_id
                                            ...
                                            $returnsStmt->bindParam(':supplier_id', $supplierId);
                                            $returnsStmt->execute();
                                            ...
                                            if (count($returns) > 0):
                                                ...
                                                foreach ($returns as $return):
                                                    ...
                                                    switch ($return['reason']) {
                                                        case 'damaged':
                                                            $reasonText = 'زیانپێکەوتوو';
                                                            break;
                                                        case 'wrong_product':
                                                            $reasonText = 'کاڵای هەڵە';
                                                            break;
                                                        case 'supplier_request':
                                                            $reasonText = 'داواکاری دابینکەر';
                                                            break;
                                                        default:
                                                            $reasonText = 'هۆکاری تر';
                                                    }
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $counter++; ?></td>
                                                        ...
                                                        <td>
                                                            <div class="action-buttons">
                                                                <button type="button" 
                                                                    class="btn btn-sm btn-outline-info rounded-circle view-return-details" 
                                                                    data-id="<?php echo $return['id']; ?>"
                                                                    data-receipt-id="<?php echo $return['receipt_id']; ?>"
                                                                    title="بینینی زیاتر">
                                                                    <i class="fas fa-eye"></i>
                                                                </button>
                                                            </div>
                                            ...
                                            <?php else: ?>
                                                <tr>
                                                    <td colspan="7" class="text-center">هیچ گەڕاندنەوەیەک نەدۆزرایەوە</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Handle return purchase button click
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            response.items.forEach(item => {
                                const remainingQuantity = item.quantity - (parseFloat(item.returned_quantity) || 0);
                                    ...
                                    itemsHtml += `<tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control return-quantity" 
                                                ...
                                                min="0" max="${remainingQuantity}" value="0" step="1">
                                        </td>
                                    </tr>`;
                                }
                            });
                            ...
                            itemsHtml += '<label for="returnReason" class="form-label">هۆکار</label>';
                            itemsHtml += '<select class="form-select" id="returnReason" name="reason">';
                            itemsHtml += '<option value="damaged">زیانپێکەوتوو</option>';
                            itemsHtml += '<option value="wrong_product">کاڵای هەڵە</option>';
                            itemsHtml += '<option value="supplier_request">داواکاری دابینکەر</option>';
                            ...
                            Swal.fire({
                                title: `گەڕاندنەوەی کاڵا لە پسووڵە ${invoiceNumber}`,
                                html: itemsHtml,
                                width: '800px',
                                showCancelButton: true,
                                ...
                                preConfirm: () => {
                                    ...
                                    const formData = $('#returnPurchaseForm').serializeArray();
                                    const quantityInputs = $('input.return-quantity');
                                    ...
                                    if (!hasReturnItems) {
                                        Swal.showValidationMessage('تکایە لانیکەم بڕی یەک کاڵا بۆ گەڕاندنەوە دیاری بکە');
                                        return false;
                                    }
                                ...
                                if (result.isConfirmed) {
                                    // Process the return
                                    processPurchaseReturn(result.value);
                                }
                            });
                        } else {
                            Swal.fire({
                                icon: 'error',
                                title: 'هەڵە',
                                text: response.message || 'هەڵەیەک ڕوویدا لە وەرگرتنی زانیاری کاڵاکان',
                                confirmButtonText: 'باشە'
                            });
                        }
                    },
            ...
            function processPurchaseReturn(formData) {
                // Convert form data array to object
                const returnData = {};
                formData.forEach(item => {
                    if (item.name.includes('return_quantities')) {
                        const match = item.name.match(/return_quantities\[(\d+)\]/);
                        if (match && match[1]) {
                ...
                Swal.fire({
                    title: 'چاوەڕێ بکە...',
                    text: 'گەڕاندنەوەی کاڵاکان پڕۆسێس دەکرێت',
                    allowOutsideClick: false,
                    didOpen: () => {
                        Swal.showLoading();
                    }
                    ...
                    success: function(response) {
                        try {
                            ...
                            if (data.success) {
                                ...
                                let summaryHtml = '<div class="text-center mb-4"><h5 class="text-success">کاڵاکان بە سەرکەوتوویی گەڕێنرانەوە</h5></div>';
                                
                                // Return summary
                                summaryHtml += '<div class="mb-2"><strong>کاڵا گەڕێنراوەکان:</strong></div>';
                                summaryHtml += '<div class="table-responsive"><table class="table table-sm table-bordered">';
                                summaryHtml += '<thead><tr><th>ناوی کاڵا</th><th>بڕی سەرەتایی</th><th>پێشتر گەڕاوە</th><th>بڕی گەڕانەوە</th><th>کۆی گەڕانەوە</th><th>بڕی ماوە</th><th>نرخی تاک</th><th>کۆی نرخ</th></tr></thead>';
                                summaryHtml += '<tbody>';
                                
                                data.summary.returned_items.forEach(item => {
                                    summaryHtml += `<tr>
                                        <td>${item.product_name}</td>
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'هەڵە',
                                text: 'هەڵەیەک ڕوویدا لە پڕۆسێسکردنی وەڵامدانەوەی سێرڤەر',
                                confirmButtonText: 'باشە'
                            });
                        }
                    },
                    ...
                    success: function(response) {
                        try {
                            ...
                            if (data.success) {
                                ...
                                data.items.forEach(item => {
                                    ...
                                    const totalPrice = parseFloat(item.total_price) || (parseFloat(item.quantity) * parseFloat(item.unit_price));
                                    ...
                                    itemsHtml += `
                                        <tr>
                                            ...
                                            <td>${totalPrice.toLocaleString()} دینار</td>
                                            <td>${reasonText}</td>
                                        </tr>
                                    `;
                                });
                                ...
                                itemsHtml += `
                                    ...
                                    <tfoot>
                                        <tr class="table-light">
                                            <td colspan="4" class="text-start fw-bold">کۆی گشتی گەڕانەوە</td>
                                            <td colspan="2" class="fw-bold">${totalAmount.toLocaleString()} دینار</td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                        `;
                                ...
                                Swal.fire({
                                    icon: 'error',
                                    title: 'هەڵە',
                                    text: data.message || 'هەڵەیەک ڕوویدا لە وەرگرتنی زانیاریەکان',
                                    confirmButtonText: 'باشە'
                                });
                            }
                        } catch (error) {
            ...
            // Refresh the returns tab when clicked
            $(document).on('click', '.refresh-returns-btn', function() {
                location.reload();
            });
        });
    </script>
