                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="action-buttons">
                                                                ...
                                                                <button type="button" class="btn btn-sm btn-outline-warning rounded-circle return-purchase" 
                                                                    data-id="<?php echo $purchase['id']; ?>"
                                                                    data-invoice="<?php echo $purchase['invoice_number']; ?>"
                                                                    title="گەڕاندنەوە">
                                                                    <i class="fas fa-undo"></i>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.return-purchase', function() {
                ...
                Swal.fire({
                    ...
                    text: `ئایا دەتەوێت کاڵا بگەڕێنیتەوە بۆ پسووڵەی ژمارە ${invoiceNumber}؟`,
                    icon: 'question',
                    showCancelButton: true,
                    confirmButtonText: 'بەڵێ، گەڕاندنەوە',
                    cancelButtonText: 'نەخێر',
                    reverseButtons: true
                }).then((result) => {
                    if (result.isConfirmed) {
                        // Redirect to the product return page with purchase ID
                        window.location.href = `../../views/inventory/return_product.php?receipt_id=${purchaseId}&receipt_type=buying`;
                    }
                });
            });
