                                        ...
                                        <div class="table-container">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mt-3">
                                                <div class="pagination-info">
                                                    <span id="employeeStartRecord">0</span> - <span id="employeeEndRecord">0</span> لە <span id="employeeTotalRecords">0</span>
                                                </div>
                                                <div class="pagination-controls">
                                                    <button type="button" class="btn btn-sm btn-outline-primary" id="employeePrevPageBtn" disabled>پێشوو</button>
                                                    <div id="employeePaginationNumbers" class="d-inline-block mx-2"></div>
                                                    <button type="button" class="btn btn-sm btn-outline-primary" id="employeeNextPageBtn" disabled>دواتر</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
