...
$query = "SELECT sdt.*, s.name as supplier_name, s.phone1 as supplier_phone, 
                 u.username as created_by_name
          FROM supplier_debt_transactions sdt
          JOIN suppliers s ON sdt.supplier_id = s.id
          LEFT JOIN admin_accounts u ON sdt.created_by = u.id
          WHERE sdt.id = :id AND sdt.transaction_type = 'supplier_advance'";
...
<head>
    ...
    <title>پسووڵەی پارەی پێشەکی دابینکەر</title>
    <!-- Bootstrap 5 RTL CSS -->
...
<body>
    <div class="container">
        ...
        <div class="receipt-header">
            ...
            <h2>پسووڵەی پارەی پێشەکی دابینکەر</h2>
        </div>
        ...
        <table class="table-receipt">
            ...
            <tr>
                <th>ژمارەی مۆبایل:</th>
                <td><?php echo htmlspecialchars($transaction['supplier_phone']); ?></td>
            </tr>
        </table>
        ...
        <div class="receipt-footer">
            <p>ئەم پسووڵەیە بەڵگەی پێدانی پارەی پێشەکییە بۆ دابینکەر</p>
            <p>سوپاس بۆ هاوکاری</p>
        </div>
    </div>
