$(document).ready(function() {
    ...
    $(document).on('click', '.print-btn', function() {
        ...
        if (type === 'sale') {
            window.open(`../../views/admin/receipt/print_receipt.php?sale_id=${id}`, '_blank');
        } else if (type === 'purchase') {
            window.open(`../../views/admin/receipt/print_receipt.php?purchase_id=${id}`, '_blank');
        } else {
            window.open(`../../views/admin/receipt/print_receipt.php?waste_id=${id}`, '_blank');
        }
    });
